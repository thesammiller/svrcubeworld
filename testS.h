...
#ifndef _TAO_IDL_TESTS_IREVP9_H_
#define _TAO_IDL_TESTS_IREVP9_H_
...
#define _SIMPLE_SERVER__SARG_TRAITS_
  ...
  template<>
  class SArg_Traits< ::Simple_Server::frameData>
    : public
        Var_Size_SArg_Traits_T<
...
public:
  ...
  virtual ::Simple_Server::frameData * sendFrameData () = 0;

  static void sendFrameData_skel (
      TAO_ServerRequest &server_request,
      TAO::Portable_Server::Servant_Upcall *servant_upcall,
      TAO_ServantBase *servant);
};
